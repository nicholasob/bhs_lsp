...
Note: Many functions are missing from the documentation. For instance, `close_file` is listed in the "Insert Trigger Function..." menu, but not in the documentation.
